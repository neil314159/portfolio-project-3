...
class TableView():
    ...
    def print_table(self):
        ...
        for a in self.patient_data[1:11]:
            ...
            new_row.append("Y") if((getattr(a, 'first_dose'))=="TRUE") else new_row.append("N")
            new_row.append("Y") if((getattr(a, 'second_dose'))=="TRUE") else new_row.append("N")
            new_row.append("Y") if((getattr(a, 'booster_dose'))=="TRUE") else new_row.append("N")
